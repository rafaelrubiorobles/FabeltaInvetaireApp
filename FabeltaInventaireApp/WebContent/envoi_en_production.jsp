...
<title>Envoi en production</title>
</head>
<body>
	<!-- Titre principale -->
	...
	<div id="divPrincipaleReception" class="row">
		<!-- Div image -->
		<c:forEach var="tempProdEnvoiEnProd" items="${PRODUITFROMENVOIENPROD}">
			<div class="col-5">
	...
	<!-- titre 2 -->
	<h2 class="text-center">ENVOYEZ LE PRODUIT EN PRODUCTION</h2>
			...
			<c:forEach var="tempProdLocationEnvoiEnProd"
				...
				<tr>
					<td><a id="codeZone" style="font-size: 25px;"
						...
						data-target="#modalEnvoiTotalEnProduction" data-toggle="modal"
						href="#modalEnvoiTotalEnProduction">${tempProdLocationEnvoiEnProd.key}</a></td>
	...
	<div class="d-flex justify-content-center">
		...
		<button type="button"
			class="btn btn-primary btn-block  btn-primary btn-menu-principale"
	...
	<!-- Modal confirmation envoi en production -->
	<%@include file="includes/modals/modal_en _production.jsp"%>

	<!-- ajout des fichiers scripts -->
	<%@include file="includes/ajoutScripts.jsp"%>
</body>
<script type="text/javascript" src="js/script.js"></script>
<script type="text/javascript" src="js/envoi_en_production_page.js"></script>
</html>